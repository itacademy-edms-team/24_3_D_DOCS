import { EntityStyle, EntityType, Profile, DEFAULT_ENTITY_STYLES } from '../types';
 ...
 */
export function getPageDimensions(size: string, orientation: string): { width: string; height: string } {
  ...
  const pageSize = sizes[size] || sizes.A4;
