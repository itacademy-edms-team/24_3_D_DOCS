...
- В ответе read_document блок «content:» с нумерацией строк — это сохранённый файл в хранилище. Блок «pending_ai_changes» — предложения, которые пользователь ещё не принял; они не входят в эти номера строк до принятия в интерфейсе(это ты их бувально сам и внес).
