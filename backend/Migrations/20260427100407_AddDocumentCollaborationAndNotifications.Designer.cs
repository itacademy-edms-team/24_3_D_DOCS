...
namespace RusalProject.Migrations
{
    ...
    [Migration("20260427100407_AddDocumentCollaborationAndNotifications")]
    partial class AddDocumentCollaborationAndNotifications
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RusalProject.Models.Entities.AgentSourcePart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("InlineText")
                        .HasColumnType("text")
                        .HasColumnName("inline_text");
                    ...
                    b.HasIndex("SessionId")
                        .HasDatabaseName("IX_AgentSourceParts_SessionId");

                    b.HasIndex("SessionId", "PartIndex")
                        .IsUnique()
                        .HasDatabaseName("IX_AgentSourceParts_Session_PartIndex");

                    b.ToTable("agent_source_parts");
                });

            modelBuilder.Entity("RusalProject.Models.Entities.AgentSourceSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ChatSessionId")
                        .HasDatabaseName("IX_AgentSourceSessions_ChatSessionId");

                    b.HasIndex("DocumentId")
                        .HasDatabaseName("IX_AgentSourceSessions_DocumentId");

                    b.HasIndex("ExpiresAt")
                        .HasDatabaseName("IX_AgentSourceSessions_ExpiresAt");

                    b.HasIndex("UserId")
                        .HasDatabaseName("IX_AgentSourceSessions_UserId");

                    b.ToTable("agent_source_sessions");
                });
            ...
            modelBuilder.Entity("RusalProject.Models.Entities.DocumentAiChange", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("document_ai_changes");
                });

            modelBuilder.Entity("RusalProject.Models.Entities.DocumentCollaborator", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("DocumentId")
                        .HasDatabaseName("IX_DocumentCollaborators_DocumentId");

                    b.HasIndex("InvitedBy");

                    b.HasIndex("UserId")
                        .HasDatabaseName("IX_DocumentCollaborators_UserId");

                    b.HasIndex("DocumentId", "UserId")
                        .IsUnique()
                        .HasDatabaseName("IX_DocumentCollaborators_Document_User");

                    b.ToTable("document_collaborators");
                });
            ...
            modelBuilder.Entity("RusalProject.Models.Entities.LlmModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("RusalProject.Models.Entities.UserEditorHotkeys", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id");
                    ...
                    b.ToTable("user_editor_hotkeys");
                });

            modelBuilder.Entity("RusalProject.Models.Entities.UserNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("RusalProject.Models.Entities.UserOllamaModelPreferences", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id");

                    b.Property<string>("AgentModelName")
                        .HasColumnType("text")
                        .HasColumnName("agent_model_name");

                    b.Property<string>("AttachmentTextModelName")
                        .HasColumnType("text")
                        .HasColumnName("attachment_text_model_name");
                    ...
                    b.Property<string>("VisionModelName")
                        .HasColumnType("text")
                        .HasColumnName("vision_model_name");

                    b.HasKey("UserId");

                    b.ToTable("user_ollama_model_preferences");
                });
            ...
            modelBuilder.Entity("RusalProject.Models.Entities.AgentSourcePart", b =>
                {
                    b.HasOne("RusalProject.Models.Entities.AgentSourceSession", "Session")
                        .WithMany("Parts")
            ...
            modelBuilder.Entity("RusalProject.Models.Entities.DocumentCollaborator", b =>
                {
                    ...
                    b.HasOne("RusalProject.Models.Entities.User", "Inviter")
                        .WithMany()
