...
namespace RusalProject.Migrations
{
    ...
    [Migration("20260216115332_FixDocumentProfileFkToProfiles")]
    partial class FixDocumentProfileFkToProfiles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RusalProject.Models.Entities.BlockEmbedding", b =>
                {
            ...
            modelBuilder.Entity("RusalProject.Models.Entities.DocumentBlock", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("RusalProject.Models.Entities.BlockEmbedding", b =>
                {
                    b.HasOne("RusalProject.Models.Entities.DocumentBlock", "Block")
                        .WithOne("Embedding")
                        .HasForeignKey("RusalProject.Models.Entities.BlockEmbedding", "BlockId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RusalProject.Models.Entities.DocumentLink", b =>
                {
                    ...
                    b.HasOne("RusalProject.Models.Entities.Profile", "Profile")
                        .WithMany()
